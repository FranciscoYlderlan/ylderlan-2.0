  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          'Contributed to the Lab Yes! architecture, which brought in **100%** of the volunteers and supported their professional development and the building of the software.',
